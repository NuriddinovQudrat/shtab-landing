...
export default function RotatingCircles() {
  return (
    <div className="flex justify-center">
      {/* 6.SIXTH-CIRCLE */}
      <div className="border-2 border-[#9A7264] lg:w-[860px] lg:h-[860px] w-[450px] h-[450px] max-[500px]:w-[260px] max-[500px]:h-[260px] rounded-full flex items-center justify-center relative">
        <div
        ...
        {/* 5.FIFTH-CIRCLE */}
        <div className="border-2 border-[#C8DBFF] lg:w-[740px] lg:h-[740px] w-[380px] h-[380px] max-[500px]:w-[220px] max-[500px]:h-[220px] rounded-full flex items-center justify-center relative">
          <div
          ...
          {/* 4.FOURTH-CIRCLE */}
          <div className="border-2 border-[#A9A8A8] lg:w-[620px] lg:h-[620px] w-[310px] h-[310px] max-[500px]:w-[180px] max-[500px]:h-[180px] rounded-full flex items-center justify-center relative">
            <div
            ...
            {/* 3.THIRD-CIRCLE */}
            <div className="border-2 border-[#9BC2AB] lg:w-[500px] lg:h-[500px] w-[240px] h-[240px] max-[500px]:w-[140px] max-[500px]:h-[140px] rounded-full flex items-center justify-center relative">
              <div
              ...
              {/* 2.SECOND-CIRCLE */}
              <div className="border-2 border-[#00A9D8] lg:w-[380px] lg:h-[380px] w-[170px] h-[170px] max-[500px]:w-[100px] max-[500px]:h-[100px] rounded-full flex items-center justify-center relative">
                <div
                ...
                {/* 1.FIRST-CIRCLE */}
                <div className="border-2 border-[#B73E94] lg:w-[260px] lg:h-[260px] w-[100px] h-[100px] max-[500px]:w-[60px] max-[500px]:h-[60px] rounded-full flex items-center justify-center relative">
                  <div
                  ...
                  {/* 0.MAIN-CIRCLE */}
                  <div className="lg:w-[140px] lg:h-[140px] w-[40px] h-[40px] max-[500px]:w-[24px] max-[500px]:h-[24px] bg-[#ffffff1a] rounded-full flex items-center justify-center">
                    <div
                      className="lg:w-16 lg:h-16 w-6 h-6 max-[500px]:w-4 max-[500px]:h-4"
                      style={{
